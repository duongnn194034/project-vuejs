  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h4 class="pt-3">Sửa đổi danh mục</h4>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 px-5 px-md-0">
        <form v-if="category">
          ...
          <button type="button" class="btn btn-primary" @click="editCategory">Xác nhận</button>
          <!-- <button type="button" class="btn btn-primary" @click="editCategory">Xóa</button> -->
        </form>
      </div>
      <div class="col-3"></div>
    </div>
